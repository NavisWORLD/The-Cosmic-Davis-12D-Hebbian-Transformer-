...
# Import 12D CST Emotional API (cosmosynapse package or standalone)
try:
    from cosmosynapse.engine.emotional_state_api import (
        EmotionalStateAPI,
        EmotionalState,
        IntentState,
        CSTPhaseState,
    ...
    # Fallback: try sibling module (standalone execution)
    sys.path.insert(0, os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
    from engine.emotional_state_api import (
        EmotionalStateAPI,
        EmotionalState,
        IntentState,
        CSTPhaseState,
...
# System prompt path — look in plugin root, then server dir
