    ...
    try {
        ...
        emotionalWs.onmessage = (event) => {
            try {
                ...
                if (packet.type === 'farnsworth_packet') {
                    // Support both server (farnsworth_packet) and demo (data) structures
                    const payload = packet.data || packet.farnsworth_packet;
        ...
        emotionalWs.onclose = () => {
            ...
            reconnectTimer = setTimeout(connectEmotionalAPI, 3000);
        };
