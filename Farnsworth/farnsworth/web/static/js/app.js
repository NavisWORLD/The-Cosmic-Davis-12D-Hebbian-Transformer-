...
Welcome to my Neural Interface v4.0! I'm Professor Farnsworth, your AI companion with FULL LOCAL FEATURES!
...
- 🐝 **Swarm Chat** - Chat with the AI collective!

**🤖 Active AI Swarm:**
- 🧠 Farnsworth • 💎 Gemini • 🎭 Claude • 🌸 Kimi • 🔮 DeepSeek • ⚡ Phi
...
Try the sidebar panels or ask me anything! *rubs hands excitedly*`;
...
function updateEmotionalDisplay(data) {
    // Extract emotional state from farnsworth_packet format
    // Handle both wrapped and flat structures
    const root = data.farnsworth_packet || data;
    ...
    container.innerHTML = thoughts.slice(0, 5).map(t => `
        <div class="thought-card">
            <div class="thought-header">
                <span class="thought-bot">${t.bot_name || 'Farnsworth'}</span>
