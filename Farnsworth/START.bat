@echo off
title Farnsworth - Full Experience
cd /d %~dp0
...
echo.
echo  ================================================================
echo       FARNSWORTH - FULL EXPERIENCE LAUNCHER v2.9
...
cls
echo.
echo  Starting Farnsworth CLI Mode...
...
echo.
echo  ============================================
echo    FARNSWORTH WEB + FULL SENSORY SYSTEM
echo  ============================================
echo.
...
echo.
    ...
    start "Farnsworth Matrix Protocol" cmd /c "python scripts/matrix_console.py"
...
echo  ========================================
echo.
set FARNSWORTH_WEB_PORT=8081
python run_web.py --demo --no-emotion
pause
goto menu
...
echo    2. Live data tokenization for Farnsworth
echo.
...
echo.
echo  Endpoints for Farnsworth AI:
...
echo.
echo  ================================================================
echo    FARNSWORTH FULL SYSTEM - COMPLETE INTEGRATION
echo  ================================================================
echo.
...
echo    [x] WebSocket API for Farnsworth AI
echo.
echo  Connect Farnsworth AI to: ws://localhost:8765/ws
echo.
echo  Cleaning up any existing processes on port 8765...
for /f "tokens=5" %%a in ('netstat -ano ^| findstr :8765 ^| findstr LISTENING') do taskkill /F /PID %%a >nul 2>&1
echo.
