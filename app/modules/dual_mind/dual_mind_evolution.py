...
class DualMindDebateSystem:
    ...
    def generate_response(self, model, input_ids, temperature=0.8, max_tokens=30):
        """Generate response from a model using its native generate() method"""
        model.eval()
        with torch.no_grad():
            # Use the model's built-in generate method for proper generation
